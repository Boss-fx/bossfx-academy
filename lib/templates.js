...
const TEMPLATES = {
    ...
    student_welcome_1: {
        ...
        html: () => wrap(
            ...
            body(
                greeting() +
                text(`Your BossFx Academy account is ready. <strong style="color:${BRAND.color};">Modules 1 and 2 of Forex 101 are free</strong> — start right now, no payment needed.`) +
                ...
                divider() +
                text(`Finish the two free modules and you’ll be ready for the full 12-module system. Let’s go.`) +
    ...
    student_welcome_2: {
        ...
        html: () => wrap(
            header('Your First 2 Modules Are Waiting', 'They’re free — don’t leave them unopened') +
            body(
                greeting() +
                text(`Quick nudge: your <strong style="color:${BRAND.color};">2 free Forex 101 modules</strong> are still waiting in your learning area.`) +
                text(`Most traders who finish these two modules describe it as the first time forex actually “clicked.” It takes about 20 minutes.`) +
