 ...
 */
async function sendFulfillmentEmail(customer, product, txRef, downloadToken) {
    ...
    const htmlContent = baseTemplate(contentFn(customer, product, txRef, downloadToken), product);
